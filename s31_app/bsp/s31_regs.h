...
/* GPIO 矩阵：把焊盘 n 的输出**接到哪个外设信号**上（n = 焊盘号）
   出处：soc/esp32s31/register/soc/gpio_reg.h 的 GPIO_FUNC0_OUT_SEL_CFG_REG（+0xaf4）
   位域：out_sel[8:0] / oen_sel[10] / oen_inv_sel[11]（AGENTS §4.12 也记了）*/
#define S31_GPIO_FUNC_OUT_SEL(n) (S31_GPIO_BASE + 0xAF4u + 4u * (n))
